...
api_instance = MergeTicketingClient::RegenerateKeyApi.new
remote_key_for_regeneration_request = MergeTicketingClient::RemoteKeyForRegenerationRequest.new({name: 'Remote Deployment Key 1'}) # RemoteKeyForRegenerationRequest | 
