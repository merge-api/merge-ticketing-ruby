...
module MergeTicketingClient
  class AttachmentsApi
    ...
    # @param ticketing_attachment_endpoint_request [TicketingAttachmentEndpointRequest] 
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :is_debug_mode Whether to include debug fields (such as log file links) in the response.
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [TicketingAttachmentResponse]
    def attachments_create(x_account_token, ticketing_attachment_endpoint_request, opts = {})
      data, _status_code, _headers = attachments_create_with_http_info(x_account_token, ticketing_attachment_endpoint_request, opts)
      data
    end
    ...
    # @option opts [Boolean] :is_debug_mode Whether to include debug fields (such as log file links) in the response.
    # @option opts [Boolean] :run_async Whether or not third-party updates should be run asynchronously.
    # @return [Array<(TicketingAttachmentResponse, Integer, Hash)>] TicketingAttachmentResponse data, response status code and response headers
    def attachments_create_with_http_info(x_account_token, ticketing_attachment_endpoint_request, opts = {})
      ...
      if @api_client.config.client_side_validation && ticketing_attachment_endpoint_request.nil?
        fail ArgumentError, "Missing the required parameter 'ticketing_attachment_endpoint_request' when calling AttachmentsApi.attachments_create"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ticketing_attachment_endpoint_request)

      # return_type
      return_type = opts[:debug_return_type] || 'TicketingAttachmentResponse'
