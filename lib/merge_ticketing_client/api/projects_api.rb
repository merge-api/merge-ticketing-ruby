...
module MergeTicketingClient
  class ProjectsApi
    ...
    def projects_list(x_account_token, opts = {})
      data, _status_code, _headers = projects_list_with_http_info(x_account_token, opts)
      data
    end
    ...
    def projects_list_with_http_info(x_account_token, opts = {})
    ...
    # @option opts [Boolean] :include_remote_data Whether to include the original data Merge fetched from the third-party to produce these models.
    # @return [Project]
    def projects_retrieve(x_account_token, id, opts = {})
      data, _status_code, _headers = projects_retrieve_with_http_info(x_account_token, id, opts)
      data
    end
    ...
    def projects_retrieve_with_http_info(x_account_token, id, opts = {})
      if @api_client.config.debugging
