...
module MergeTicketingClient
  class TagsApi
    ...
    # @option opts [Boolean] :include_remote_data Whether to include the original data Merge fetched from the third-party to produce these models.
    # @return [Tag]
    def tags_retrieve(x_account_token, id, opts = {})
      data, _status_code, _headers = tags_retrieve_with_http_info(x_account_token, id, opts)
      data
    end
    ...
    def tags_retrieve_with_http_info(x_account_token, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TagsApi.tags_retrieve ...'
      end
      # verify the required parameter 'x_account_token' is set
      if @api_client.config.client_side_validation && x_account_token.nil?
        fail ArgumentError, "Missing the required parameter 'x_account_token' when calling TagsApi.tags_retrieve"
      end
      ...
      new_options = opts.merge(
        :operation => :"TagsApi.tags_retrieve",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
