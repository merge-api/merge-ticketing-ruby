...
# Unit tests for MergeTicketingClient::Ticket
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::Ticket do
  let(:instance) { MergeTicketingClient::Ticket.new }

  describe 'test an instance of Ticket' do
    it 'should create an instance of Ticket' do
      expect(instance).to be_instance_of(MergeTicketingClient::Ticket)
    end
  end
