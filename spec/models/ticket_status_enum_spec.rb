...
# Unit tests for MergeTicketingClient::TicketStatusEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::TicketStatusEnum do
  let(:instance) { MergeTicketingClient::TicketStatusEnum.new }

  describe 'test an instance of TicketStatusEnum' do
    it 'should create an instance of TicketStatusEnum' do
