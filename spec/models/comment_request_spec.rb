...
# Unit tests for MergeTicketingClient::CommentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::CommentRequest do
  let(:instance) { MergeTicketingClient::CommentRequest.new }

  describe 'test an instance of CommentRequest' do
    it 'should create an instance of CommentRequest' do
