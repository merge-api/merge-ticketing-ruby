...
# Unit tests for MergeTicketingClient::AccountDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::AccountDetails do
  let(:instance) { MergeTicketingClient::AccountDetails.new }

  describe 'test an instance of AccountDetails' do
    it 'should create an instance of AccountDetails' do
      expect(instance).to be_instance_of(MergeTicketingClient::AccountDetails)
    end
  end
