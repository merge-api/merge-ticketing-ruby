...
# Unit tests for MergeTicketingClient::Attachment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::Attachment do
  let(:instance) { MergeTicketingClient::Attachment.new }

  describe 'test an instance of Attachment' do
    it 'should create an instance of Attachment' do
      expect(instance).to be_instance_of(MergeTicketingClient::Attachment)
    end
  end
