...
# Unit tests for MergeTicketingClient::Contact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::Contact do
  let(:instance) { MergeTicketingClient::Contact.new }

  describe 'test an instance of Contact' do
    it 'should create an instance of Contact' do
      expect(instance).to be_instance_of(MergeTicketingClient::Contact)
    end
  end
