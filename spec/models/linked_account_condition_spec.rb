...
# Unit tests for MergeTicketingClient::LinkedAccountCondition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::LinkedAccountCondition do
  let(:instance) { MergeTicketingClient::LinkedAccountCondition.new }

  describe 'test an instance of LinkedAccountCondition' do
    it 'should create an instance of LinkedAccountCondition' do
      expect(instance).to be_instance_of(MergeTicketingClient::LinkedAccountCondition)
    end
  end
