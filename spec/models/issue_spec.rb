...
# Unit tests for MergeTicketingClient::Issue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::Issue do
  let(:instance) { MergeTicketingClient::Issue.new }

  describe 'test an instance of Issue' do
    it 'should create an instance of Issue' do
      expect(instance).to be_instance_of(MergeTicketingClient::Issue)
    end
  end
