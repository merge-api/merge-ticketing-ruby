...
# Unit tests for MergeTicketingClient::Tag
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::Tag do
  let(:instance) { MergeTicketingClient::Tag.new }

  describe 'test an instance of Tag' do
    it 'should create an instance of Tag' do
      expect(instance).to be_instance_of(MergeTicketingClient::Tag)
    end
  end
