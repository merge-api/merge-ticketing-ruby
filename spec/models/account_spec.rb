...
# Unit tests for MergeTicketingClient::Account
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::Account do
  let(:instance) { MergeTicketingClient::Account.new }

  describe 'test an instance of Account' do
    it 'should create an instance of Account' do
      expect(instance).to be_instance_of(MergeTicketingClient::Account)
    end
  end
