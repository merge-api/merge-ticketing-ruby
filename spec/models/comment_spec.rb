...
# Unit tests for MergeTicketingClient::Comment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::Comment do
  let(:instance) { MergeTicketingClient::Comment.new }

  describe 'test an instance of Comment' do
    it 'should create an instance of Comment' do
      expect(instance).to be_instance_of(MergeTicketingClient::Comment)
    end
  end
