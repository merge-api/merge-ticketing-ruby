...
# Unit tests for MergeTicketingClient::Team
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeTicketingClient::Team do
  let(:instance) { MergeTicketingClient::Team.new }

  describe 'test an instance of Team' do
    it 'should create an instance of Team' do
      expect(instance).to be_instance_of(MergeTicketingClient::Team)
    end
  end
